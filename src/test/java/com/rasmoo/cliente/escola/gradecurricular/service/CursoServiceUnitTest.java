...
public class CursoServiceUnitTest {
    ...
    public void testListarSucesso() {
        ...
        List<CursoEntity> listCursoEntity = this.cursoService.listarCursos();
    ...
    public void testAtualizarThrowCursoException() {
        ...
        assertEquals(MensagensConstant.ERRO_CURSO_NAO_ENCONTRADO.getDescricao(), cursoException.getMessage());
    ...
    public void testCadastrarComIdThrowMateriaException() {
        ...
        assertEquals(MensagensConstant.ERRO_ID_INFORMADO.getDescricao(), cursoException.getMessage());
    ...
    public void testCadastrarComCodigoExistenteThrowMateriaException() {
        ...
        assertEquals(HttpStatus.BAD_REQUEST, cursoException.getHttpStatus());
        assertEquals(MensagensConstant.ERRO_CURSO_CADASTRADO_ANTERIORMENTE.getDescricao(), cursoException.getMessage());
    ...
    public void testAtualizarThrowException() {
        ...
        assertEquals(MensagensConstant.ERRO_GENERICO.getDescricao(), cursoException.getMessage());
